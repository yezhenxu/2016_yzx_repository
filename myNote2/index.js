...
app.use(session({
    secret: '1234',
    name: 'mynote',
    cookie: {maxAge: 1000 * 60 * 60 * 7},  //设置session的保持时间为1s* 60*60*7天
    resave: false,
...
app.post('/getPassword',function(req,res){
    ...
    User.findOne({username: user_name}, function (err, user) {
        if (err) {
            console.log(err);
            return res.redirect('/getPassword');
        }
    ...
    var transporter=nodemailer.createTransport({
        ...
        host: 'smtp.163.com',
        auth:{
            user:  'yezhenxu1992@163.com',
            pass: 'yezhenxu123'
        }
    });

    var mailOptions={
        from:'yezhenxu1992@163.com',
        to:'yezhenxu@pku.edu.cn',
